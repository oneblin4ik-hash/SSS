...
Ни отсчёта, ни счётчика мест, ни дедлайна на странице нет.
...
в роли старой это недостоверная реклама. Поэтому её убрали совсем.
...
INCLUDED = [
    ...
    ("🧮", "Своя норма КБЖУ", "посчитанная в первый день — дальше все решения про еду опираются на неё"),
...
FAQ = [
    ...
    ("А после шести есть нельзя?",
     ...
     "целиком — твоя норма КБЖУ и дефицит, если цель похудение. Вечером "
     "лучше белок или белок с овощами, дальше смотри по сну и самочувствию."),
    ("А если пропущу день?",
  ...
  <main class="grid">
    <section class="offer">
      ...
      <div class="inner">
        ...
        <div class="price">
          <span class="rub">1&thinsp;890 ₽</span>
          <span class="once">один раз, навсегда твоё</span>
          <span class="once">без подписки и доплат</span>
        </div>
