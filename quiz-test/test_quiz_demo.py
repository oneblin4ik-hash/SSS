...
#   [последний раз · что делал] · минут · раз в неделю · здоровье
RUNS = [
    {
        ...
        "w_now": 78, "w_goal": 66,
        "picks": [0, 0, 4, 2, 1, 0, 1, 1, 1, 6],
        "steps": 16,
        "expect": {"n": "Галина", "g": "f", "h": 165, "t": "onoff",
                   "ex": "quit", "ls": "m1", "zn": "belly", "tr": 2},
        "shots": "onoff",
    },
    {
        ...
        "w_now": 96, "w_goal": 88,
        "picks": [0, 3, 5, 3, 0, 0, 0, 6],
        "steps": 14,
        "expect": {"n": "Пётр", "g": "m", "h": 178, "t": "never",
                   "ex": "never", "ls": None, "dd": None, "tr": 1},
        "shots": "never",
    },
    {
        ...
        "w_now": 63, "w_goal": 61,
        "picks": [2, 1, 2, 4, 1, 2, 0, 2, 2, 6],
        "steps": 16,
        "expect": {"n": "Марина", "g": "f", "t": "quit",
                   "ex": "quit", "ls": "y1", "gl": "tone", "tr": 3},
        "shots": "quit",
    },
]
