...
table.wk td.num .slot {
  height: 6mm; border: 0.25mm dashed #9AA0AE; border-radius: 1mm; background: #FFFFFF;
}
"""
...
def day1() -> dict:
    ...
    return {
        "title": "Аудит режима",
        "page": A4,
        "lead": "Заполни за один обычный день. Не за неделю и не за идеальный "
                "день — за сегодняшний. Сегодня ничего не меняем.",
        "body": f"""
...
def day2() -> dict:
    ...
    return {
        ...
        "page": PHONE,
        "lead": "Ни одного запрета и никакого счёта калорий. Один принцип, "
...
def day6() -> dict:
    ...
    return {
        ...
        "page": PHONE,
        "lead": "Вечерний голод — почти всегда счёт за день. Не терпим вечером, "
                "а добираем днём.",
        "body": f"""
...
def day7() -> dict:
    ...
    return {
        ...
        "page": PHONE,
        "lead": "Неделя. Смотрим честно — без самобичевания и без натягивания.",
        "body": f"""
...
def day8() -> dict:
    ...
    return {
        ...
        "page": A4,
        "lead": "Еду не убираем. Убираем ежедневный выбор: три завтрака, три "
                "обеда, три ужина, которые ты умеешь, любишь и соберёшь быстро.",
        "body": f"""
...
def day9() -> dict:
    return {
        ...
        "page": PHONE,
        "lead": "Тот же комплекс, но сегодня чуть больше, чем в четвёртый день. "
                "На повтор, на подход, на пять секунд в планке.",
        "body": f"""
...
def day10() -> dict:
    return {
        ...
        "page": PHONE,
        "lead": "Запрещённых продуктов в этой системе нет. Не поблажка, а расчёт.",
        "body": f"""
<div class="chain">
...
def day11() -> dict:
    return {
        ...
        "page": PHONE,
        "lead": "15 минут вместо 40. Три упражнения вместо шести. Прямо в "
                "комнате, в чём стоишь.",
        "body": f"""
...
def day14() -> dict:
    ...
    return {
        ...
        "page": PHONE,
        "lead": "Четырнадцать дней. Смотрим, что осталось на руках.",
        "body": f"""
<div class="ab">
  <div class="pt">
