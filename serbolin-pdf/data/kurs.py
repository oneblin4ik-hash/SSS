...
_DIVIDER = {
    ...
    2: ("Начинаются действия: первая тренировка, день отдыха по плану, вечерняя "
        ...
        "do-posle-70-62", "center",
        "70 → 62 кг за три месяца, и это с травмами позвоночника. "
        "Начинается такое всегда одинаково: одна тренировка и один "
        "обычный день, записанный честно."),
