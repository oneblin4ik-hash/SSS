...
# Светлая схема — внутренние страницы
BG = "#F5F6F9"
SURFACE = "#FFFFFF"
SURFACE_2 = "#F2F3F6"
SURFACE_3 = "#EDEEF2"
BAR = "#E7E9EF"          # трек прогресса, пустые ячейки таблиц
INK = "#292F3B"          # заголовки — графит, не чёрный
...
# таблица суток (день 1), список покупок (день 8), протокол срыва (день 12).
A4 = Page("a4", 210, 297, 17, 19, 15, 11.5)
...
LEVELS = [
    {"n": 1, "emoji": "🔍", "name": "Диагностика", "days": (1, 3)},
    {"n": 2, "emoji": "⚙️", "name": "Первые шаги", "days": (4, 7)},
    {"n": 3, "emoji": "🧩", "name": "Система", "days": (8, 10)},
    {"n": 4, "emoji": "🛡", "name": "Закрепление", "days": (11, 14)},
]
